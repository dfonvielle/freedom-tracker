...
Plan: [PLAN_freedom_home_and_providers.md](https://github.com/dfonvielle/mission_control/blob/main/../../PLAN_freedom_home_and_providers.md) (lives at coding_projects root) · doctrine: DRUNK_GRANDPA_STRATEGY.md (root) · coach eval journeys: [gateway ai_research](https://github.com/dfonvielle/freedom_tracker_gateway/tree/main/ai_research)
