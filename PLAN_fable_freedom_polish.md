...
| 3 | Tool-edge contracts (NBWE terse-accept, shared privacy rule, RBF fast-track intro) — draft → verify → LIVE | TODO |
| 4 | Deep tool stress: RBF full session + F&A + Withdrawal + FGS/CJC terse spots + scramble log check | TODO |
| 5 | The before/after record: FABLE_INTERVENTION doc, after-fable tags, dashboard, pushes | TODO |
